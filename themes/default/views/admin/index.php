...
<div id="top-pane" class="ui-layout-north" style="overflow:hidden">
	<iframe src="<?php echo $topUrl; ?>" name="top" width="100%" frameborder="0" height="20" marginheight="0"
	        scrolling="no"></iframe>
</div>
<div id="left-pane" class="ui-layout-west">
	<!-- left bar -->
	<iframe src="<?php echo $leftUrl; ?>" name="left" width="100%" height="100%" frameborder="0" scrolling="auto"
	        marginheight="0"></iframe>
</div>

<div id="right-pane" class="ui-layout-center">
	<!-- right bar -->
	<iframe src="<?php echo $rightUrl; ?>" name="right" width="100%" height="100%" frameborder="0" marginheight="0"
...
<div class="server-menu" style="width:120px">
	...
	<a href="<?php h(url("server.databases")); ?>" target="right"><?php hm("databases"); ?></a> <a
	href="<?php h(url("server.createDatabase")); ?>" target="right" title="Create new Database">[+]</a> <br/>
