...
<h3><?php render_navigation($db, $collection, false); ?> &raquo; <?php hm("modifyrow"); ?> '<?php h($row["_id"]);?>' [<a
...
<form method="post">
	...
	<input type="submit" value="<?php hm("save"); ?>"/> <input type="button" value="<?php hm("back"); ?>"
	                                                           onclick="window.location='<?php h(xn("uri"));?>'"/>
</form>