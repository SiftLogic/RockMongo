<h3><?php render_navigation($db, $collection, false); ?> &raquo; <?php hm("indexes");?> [<a
	href="<?php h($_SERVER["REQUEST_URI"]);?>"><?php hm("refresh"); ?></a>]</h3>
...
<table width="600" cellpadding="2" cellspacing="1" bgcolor="#cccccc">
	...
	<tr bgcolor="#ffffff">
		...
		<td align="center" valign="top"><?php if (!isset($index["key"]["_id"]) || count($index["key"]) != 1): ?> <a
			href="<?php
				...
				?>"
			onclick="return window.confirm('<?php hm("warningindex"); ?> \'<?php h($index["name"]);?>\'?');"><?php hm("drop"); ?></a><?php endif;?>
		</td>
	</tr>
	<?php endforeach; ?>
</table>