...
<p>См. <a href="http://code.google.com/p/rock-php/wiki/rock_mongo" target="_blank">http://code.google.com/p/rock-php/wiki/rock_mongo</a> подробнее.</p>
...
<li><a href="http://code.google.com/p/rock-php/wiki/Donation" target="_blank">Помочь материально<br/><img src="http://www.paypal.com/en_US/i/btn/x-click-but04.gif"/></a></li>
...
$message["rockmongocredits"] = "Работает на RockMongo v" . (ROCK_MONGO_VERSION) . ", <a href=\"http://code.google.com/p/rock-php/downloads/list\" target=\"_blank\">посмотреть новую версию.</a>";
